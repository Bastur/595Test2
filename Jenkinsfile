    ...
    stages {
        ...
        stage('Build'){
            steps{
                ...
                sh "ls -all"
                sh 'cd /HelloWorld/lib/ ; wget https://repo1.maven.org/maven2/org/junit/platform/junit-platform-console-standalone/1.7.0/junit-platform-console-standalone-1.7.0-all.jar'
